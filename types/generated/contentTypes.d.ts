...
export interface ApiRelatnewRelatnew extends Schema.SingleType {
  collectionName: 'relatnews';
  info: {
    singularName: 'relatnew';
    pluralName: 'relatnews';
    displayName: 'PinNews';
    description: '';
  };
  options: {
  ...
  attributes: {
    blog_news: Attribute.Relation<
      'api::relatnew.relatnew',
      'oneToMany',
      'api::blog.blog'
    >;
    createdAt: Attribute.DateTime;
